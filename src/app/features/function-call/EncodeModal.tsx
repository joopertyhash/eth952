...
const EncodeModal = ({ closeModal, args, types, inputs, opts }) => {
  ...
  useEffect(() => {
    ...
    if (inputs.length > 0) {
      ...
      setEncoded("Нету вводов");
    }
  }, [args, types, inputs]);

  return (
    <ModalContainer>
      <ModalHeader onCloseClick={closeModal} label="Подтвердить через прокси" />
      <ModalContent>
        <div style={{ marginTop: "1rem" }}>ВВОДЫ:</div>
        ...
        <div style={{ marginTop: "1rem" }}>Декодированно:</div>
